...
pug_mixins["script"]([
      {name: "d3", version: "main", path: "d3.min.js"},
      {name: "d3-color", version: "main", path: "d3-color.min.js"},
      {name: "d3-interpolate", version: "main", path: "d3-interpolate.min.js"},
      {name: "d3-scale-chromatic", version: "main", path: "d3-scale-chromatic.min.js"},
      {name: "d3-geo", version: "main", path: "d3-geo.min.js"},
      {name: "d3-geo-projection", version: "main", path: "d3-geo-projection.min.js"},
      {name: "topojson", version: "main", path: "topojson.min.js"}
    ]);
